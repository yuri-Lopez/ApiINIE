...
public class AutoresController {
    ...
    public List<Autores> traerautores(){
        return objautserv.traerautores();
    }
    ...
    public Autores traerunicoautor(@PathVariable ("documento")String documento){
        return objautserv.traerunicoautor(documento);
    }
    ...
    public AutorespecificoDto autorespecifico(@PathVariable ("documento")String documento){
        return objautserv.traerespecifico(documento);
    }
    ...
    public String Crearautor(@RequestBody Autores autor){
...
//    }
    ...
    public String actualizarautor(@RequestBody Autores autor){
    ...
    public String eliminarautor(@PathVariable ("documento")String documento){
